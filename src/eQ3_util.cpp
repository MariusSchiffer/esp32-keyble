...
string compute_auth_value(string data, char msg_type_id, string session_open_nonce, uint16_t security_counter,
                          std::string key) {
    Serial.println("compute auth value");
    assert(key.length() == 16);
